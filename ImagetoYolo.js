...
const App = () => {
  ...
  const handleFile = async (e) => {
    ...
    img.onload = async () => {
      ...
      const feeds = { images: tensor }; // Replace 'images' with your model's input name
      const outputMap = await model.run(feeds);
      const output = Object.values(outputMap)[0]; // Assuming single output
  ...
  return (
    <div>
      <h2>YOLO Detection with Bounding Box</h2>
